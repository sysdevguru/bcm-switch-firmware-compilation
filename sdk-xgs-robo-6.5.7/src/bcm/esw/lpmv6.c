                         ...
                         _bcm_defip_cfg_t *lpm_cfg, int *nh_ecmp_idx)
{
    ...
    if (soc_feature(unit, soc_feature_ipmc_defip) &&
            (SOC_MEM_OPT_FLD32_GET(unit, L3_DEFIP_PAIR_128m, hw_entry, MULTICAST_ROUTEf))) {
        ...
        lpm_cfg->defip_mc_group = SOC_MEM_OPT_FLD32_GET(unit, L3_DEFIP_PAIR_128m, hw_entry, L3MC_INDEXf);
    }
#endif
...
{
   defip_hit_only_entry_t lpm_hit;
   defip_hit_only_entry_t lpm_hit_copy;
   defip_data_only_entry_t lpm_data;
   defip_data_only_entry_t lpm_data_copy;
   defip_entry_t defip_entry_lwr;
   defip_entry_t defip_entry_upr;
   defip_entry_t defip_entry;
