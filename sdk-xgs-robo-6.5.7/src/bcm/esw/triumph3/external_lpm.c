/* $Id: external_lpm.c,v 1.6 Broadcom SDK $
...
_tr3_lpm_sw_image_p _lpm_sw_image[_TR3_LPM_IP_VERSIONS][SOC_MAX_NUM_DEVICES];
...
_tr3_ext_lpm_reset(int unit, int v6, int index)
{
    ...
    return soc_tr3_set_vbit(unit, mem, index, 0);
}
...
int bcm_esw_triumph_external_lpm_not_empty;
